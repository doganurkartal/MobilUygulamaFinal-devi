...
public class kutuphane extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ref = FirebaseDatabase.getInstance().getReference().child("kategori").child("kutuphane");

        Query query = FirebaseDatabase.getInstance().getReference("kategori").child("kutuphane");
