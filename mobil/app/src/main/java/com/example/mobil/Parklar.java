...
public class Parklar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ref = FirebaseDatabase.getInstance().getReference().child("kategori").child("parklar");

        Query query = FirebaseDatabase.getInstance().getReference("kategori").child("parklar");
