...
public class ibadet extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ref = FirebaseDatabase.getInstance().getReference().child("kategori").child("ibadet");

        Query query = FirebaseDatabase.getInstance().getReference("kategori").child("ibadet");
