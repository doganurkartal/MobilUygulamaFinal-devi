...
public class oteller extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ref = FirebaseDatabase.getInstance().getReference().child("kategori").child("oteller");

        Query query = FirebaseDatabase.getInstance().getReference("kategori").child("oteller");
