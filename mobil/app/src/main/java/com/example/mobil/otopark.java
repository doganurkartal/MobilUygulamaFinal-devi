...
public class otopark extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ref = FirebaseDatabase.getInstance().getReference().child("kategori").child("otopark");

        Query query = FirebaseDatabase.getInstance().getReference("kategori").child("otopark");
